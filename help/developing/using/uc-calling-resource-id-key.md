...
1. Klicka på knappen **[!UICONTROL Create element]** i avsnittet **[!UICONTROL Identification keys]**.
...
1. Klicka på **[!UICONTROL Add an element]** på fliken **[!UICONTROL Filter definition]** och ange sedan filterdefinitionens etikett och ID.
...
1. I avsnittet **[!UICONTROL Filter conditions]** behåller du operatorn **[!UICONTROL Equal]**, definierar parameterns namn och klickar på plustecknet för att skapa det.
...
Mer information finns i dokumentationen för [Campaign Standardens REST API:er](../../api/using/filtering.md).
