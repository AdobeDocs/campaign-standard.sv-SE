...
+ Kommunikationskanaler {#communication-channels}
   ...
   + SMS {#sms-messages}
      ...
      + [Om SMS och push-innehållsdesign](channels/using/about-sms-and-push-content-design.md)
   ...
   + Direktreklam {#direct-mail}
      ...
      + [Återgå till avsändaren](channels/using/return-to-sender.md)
...
+ Rapportering {#reporting}
   ...
   + Förteckning över rapporter {#list-of-reports}
      ...
      + [Ej levererbara produkter och studsar](reporting/using/non-deliverables-and-bounces.md)
      ...
      + [Avbeställ](reporting/using/unsubscriptions.md)
...
+ Utvecklar {#developing}
   ...
   + Lägga till eller utöka en resurs {#adding-or-extending-a-resource}
      + [Viktiga steg för att lägga till en resurs](developing/using/key-steps-to-add-a-resource.md)
      ...
      + [Konfigurerar filterdefinition](developing/using/configuring-filter-definition.md)
      + [Uppdaterar databasstrukturen](developing/using/updating-the-database-structure.md)
...
+ Arbeta med API:er {#working-with-apis}
   ...
   + Globala begrepp {#global-concepts}
      ...
      + Ytterligare åtgärder {#additional-operations}
         ...
         + [Inventering](api/using/counting.md)
   ...
   + Hantera profiler {#managing-profiles}
      ...
      + [Uppdaterar profiler](api/using/updating-profiles.md)
   ...
   + Hantera arbetsflöden {#managing-workflows}
      + [Styra ett arbetsflöde](api/using/controlling-a-workflow.md)
