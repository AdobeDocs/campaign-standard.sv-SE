...
Om du vill veta mer om hur målprofilerna fungerar kan du spåra hur de reagerar på en leverans: mottagning, öppning, klickningar på länkar, prenumerationer osv. Se fliken **Spårningsloggar** för leveransen.
...
**Tips** - Det finns inbyggda rapporter som du kan använda för att övervaka dina kampanjer, men dessa rapporter kan också anpassas genom att dra och släppa mätvärden eller dimensioner i rapporten.
...
Mer information finns i rapporten [Hot Click](../../reporting/using/hot-clicks.md).
