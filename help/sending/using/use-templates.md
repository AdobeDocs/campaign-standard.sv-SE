...
**Tips**: För att undvika konfigurationsfel i Campaign rekommenderar vi att du duplicerar en intern mall och ändrar dess egenskaper i stället för att skapa en ny mall.
...
Om du vill ändra namnet på den avsändare som ska visas i meddelandehuvudet går du till fliken **[!UICONTROL Properties]** på hemsidan för e-post-Designer (nås via hemikonen) och klickar på blocket **[!UICONTROL Default sender name]**.
...
**Tips** - Om du vill förbättra mottagarens upplevelse ytterligare kan du lägga till en persons namn, till exempel Emma från Megastore.
