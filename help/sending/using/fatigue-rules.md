...
1. Klicka på Adobe Campaign logotyp i det övre vänstra hörnet av gränssnittet och välj **[!UICONTROL Administration]** > **[!UICONTROL Channels]** > **[!UICONTROL Typologies]** > **[!UICONTROL Typology rules]**.
