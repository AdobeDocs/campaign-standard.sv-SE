...
description: Lär dig hur du visar en bild från ett push-meddelande för Adobe Campaign på en iOS-enhet.
...
# Visa en bild från ett push-meddelande för Adobe Campaign Standard {#image-push}
...
Genom att konfigurera både Adobe Campaign och Adobe Mobile Services kan ni använda mobilprogrammets data för era kampanjer. Mer information finns på den här [sidan](https://helpx.adobe.com/campaign/kb/configuring-app-sdk.html).
...
När du har anpassat push-meddelandet i Adobe Campaign måste du konfigurera ditt mobilprogram så att bilden visas på enheter.
...
1. I Xcode-projektet väljer du **Arkiv** > **Nytt** > **Mål**.
