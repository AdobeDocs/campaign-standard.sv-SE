...
Du gör detta genom att [infoga ett anpassningsfält](../../designing/using/personalization.md#inserting-a-personalization-field) i meddelandeinnehållet.
...
1. Bläddra igenom **[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]** för att hämta anpassningsfälten: Förnamn, efternamn, efternamn, totalbelopp.
