...
Innan du börjar med transaktionsmeddelanden bör du kontrollera att du har läst motsvarande [metodtips och begränsningar](../../channels/using/transactional-messaging-limitations.md).
...
**Händelsetransaktionsmeddelandets** måldata som finns i själva händelsen. Dessa meddelanden:
...
**Profilera transaktionsmeddelandenmålprofiler** från marknadsföringsdatabasen för Campaign. Med den här typen av meddelanden kan du:
...
| Användare | Åtgärd | Resultat |
|--- |--- |--- |
| Detta steg kan utföras av en marknadsföringsanvändare som har [administrationsrättigheter](../../administration/using/users-management.md#functional-administrators). | Redigera och anpassa transaktionsmeddelandet, testa det och publicera det sedan. | Transaktionsmeddelandet är sedan klart att skickas. |
