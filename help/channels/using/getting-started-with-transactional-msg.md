...
Vi presenterar begreppet **transaktionsmeddelanden**
...
* De är inte kompatibla med [trötthetsregler](../../sending/using/fatigue-rules.md) (även om det gäller en anrikning med profiler).
...
* Observera att det här steget måste utföras av en användare med [administrationsrättigheter](../../administration/using/users-management.md#functional-administrators).
...
Mer information om hur du redigerar och publicerar ett transaktionsmeddelande finns i [Händelsetransaktionsmeddelanden](../../channels/using/event-transactional-messages.md).
...
Mer information om hur du integrerar evenemanget på webbplatsen finns i [Platsintegrering](../../administration/using/configuring-transactional-messaging.md#integrating-the-triggering-of-the-event-in-a-website).
