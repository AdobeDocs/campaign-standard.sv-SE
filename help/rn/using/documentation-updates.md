...
En anteckning har lagts till för att specificera följande: när korrektur skickas med hjälp av profilersättning läggs poster till i de valda profilernas loggar. [Läs mer](../../sending/using/testing-messages-using-target.md)
