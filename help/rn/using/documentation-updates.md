...
Integreringarna med Adobe Experience Platform Data Connector och målgruppstjänsten är nu föråldrade. [Läs mer](deprecated-features.md)

Användningen av SMTP-testläge har beskrivits närmare. [Läs mer](../../administration/using/configuring-email-channel.md#smtp-test-mode)
