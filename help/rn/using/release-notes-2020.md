...
description: Den här sidan innehåller alla 2020-utgåvor av Adobe Campaign Standard.
...
* Korrigerade ett fel med arbetsflödesaktiviteten för det externa API:t som misslyckades vid länkning till anrikningsaktiviteter.
