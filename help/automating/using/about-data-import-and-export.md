...
Adobe Campaign erbjuder också ett förenklat sätt att utföra vanliga importer som består av att designa **importera mallar**. Importmallar är specialiserade arbetsflödesmallar som är tillgängliga via en dedikerad skärm. När den har designats behöver den användare som utför importen bara överföra filen för import i en förenklad vy.
