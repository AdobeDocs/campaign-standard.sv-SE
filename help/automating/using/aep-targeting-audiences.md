...
När du har skapat en [Adobe Experience Platform-målgrupp](../../audiences/using/aep-about-audience-destinations-service.md) med Segment Builder kan du använda den på samma sätt som en Campaign-målgrupp inom arbetsflöden för att personalisera och skicka meddelanden.
