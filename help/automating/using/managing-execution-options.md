...
* **[!UICONTROL Severity]**: gör att du kan ange en prioritetsnivå för att köra arbetsflöden i din Adobe Campaign-instans. Det här fältet används endast av Adobe team för övervakning.
