...
## Viktiga steg för att skapa e-post {#key-steps-to-create-your-email}
...
- **[!UICONTROL Divider]**
   ...
   Använd den här komponenten för att infoga en avdelningslinje i e-postmeddelandet. Du kan välja färg, format och storlek för den brutna linjen i **[!UICONTROL Component Settings]**.
...
- **[!UICONTROL Html]**
   ...
   Adobe rekommenderar att du skapar ett helt nytt meddelande och kopierar innehållet från din befintliga e-post till fragment och komponenter för att göra ett externt innehåll kompatibelt med e-postdesignern.
...
- **[!UICONTROL Video]**
   ...
   Använd den här komponenten för att infoga en video i e-postmeddelandet.
