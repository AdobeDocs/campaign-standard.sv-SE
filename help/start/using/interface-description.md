...
* Kortet **[!UICONTROL Create an In-App message]** tar dig till assistenten för att skapa appar. Med den här assistenten kan du välja vilken typ av meddelanden i appen som du vill skapa, definiera dess egenskaper, målgrupp och innehåll. Se avsnittet [Skapa ett meddelande i appen](../../channels/using/about-in-app-messaging.md).
...
* Logotypen **Adobe** i sidans övre vänstra hörn ger dig tillgång till de avancerade funktionerna och konfigurationerna. Menyer beror på din profil och dina behörigheter.
...
Ikonen **Hjälp** i det övre högra hörnet för Adobe Experience League in i produkten.
...
1. Fliken **[!UICONTROL Help]** innehåller:
   ...
   * en **[!UICONTROL Community]**-länk för att komma åt det forum som är dedikerat till dina frågor om Campaign.
   * direktåtkomst till: Help Center, Customer Care, Experience Cloud produktstatus, Developer Connection, Release Notes, Release Planning och skärmen **[!UICONTROL About]**.
1. På fliken **[!UICONTROL Support]** kan du öppna ett supportärende och kontakta oss via telefon eller X (tidigare Twitter).
1. Fliken **[!UICONTROL Feedback]** gör det enklare att rapportera problem eller dela dina idéer.
