...
description: Lär dig mappa ett Campaign Standard-fält med ett XDM-fält (Experience Data Model).
...
I det här avsnittet får du lära dig att mappa ett Campaign Standard-fält med ett XDM-fält (Experience Data Model).
...
Följande skärm visar avsnittet **[!UICONTROL Field mappings]** där du kan skapa en ny mappning för varje fält i Campaign Standard-schemat.

![](assets/aep_fieldmappings.png)

Med knappen **[!UICONTROL Create new field mapping]** kan du markera Campaign Standard-fältet och motsvarande fältsökvägsuttryck i XDM-schemat.
...
De utökade resurserna som definieras i Campaign Standard mappas som alla inbyggda fält. De definieras i tillägget _customer/default i XDM.
