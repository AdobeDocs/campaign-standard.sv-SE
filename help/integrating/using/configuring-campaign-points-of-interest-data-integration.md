...
>[!NOTE]
>
>Ditt mobilprogram bör redan vara konfigurerat i Adobe Campaign Standard med Adobe Experience Platform SDK. Detaljerade anvisningar finns på [sidan](https://helpx.adobe.com/se/campaign/kb/configuring-app-sdk.html).
...
1. När du har konfigurerat tilläggen skapar du dataelement i användargränssnittet för datainsamling för att hämta data från tilläggen. Se den här [sidan](https://helpx.adobe.com/campaign/kb/config-app-in-launch.html#Step1Createdataelements) för att skapa dataelement.
...
1. Skapa ett återanslående.
   ...
   * I fältet **[!UICONTROL URL]** kopierar du URL:en **[!UICONTROL Collect PII Endpoint]** från mobilprogrammet som du konfigurerade i Adobe Campaign-gränssnittet, föregånget av servernamnet. Se [Konfigurera en mobilapp i Campaign](#setting-up-a-mobile-app-in-campaign).
   ...
   * I **Vilka datataggar utlöser återanslående?**, välj en händelse, vanligtvis **[!UICONTROL Launched]** och **[!UICONTROL exists]**.
   * Klicka på **[!UICONTROL Save & Activate]**.

1. Skapa en andra återanslående.

   * Välj **[!UICONTROL Postback]** som **[!UICONTROL Postback Type]**.
   * I fältet **[!UICONTROL URL]** kopierar du URL:en **[!UICONTROL Location Services Endpoint]** från mobilprogrammet som du konfigurerade i Adobe Campaign-gränssnittet, föregånget av servernamnet. Se [Konfigurera en mobilapp i Campaign](#setting-up-a-mobile-app-in-campaign).
   * Fyll i fältet **[!UICONTROL Post Body]** enligt följande:
   ...
   * Ange **innehållstypen** som **[!UICONTROL application/json]**.
   * I **Vilka datataggar utlöser återanslående?**, välj **[!UICONTROL campaign.test]** och **[!UICONTROL exists]**.
   * Klicka på **[!UICONTROL Save & Activate]**.
...
Det här steget beskrivs på sidan [Konfigurera ett mobilprogram med SDK V4](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/configuring-channels/configuring-a-mobile-application.html?lang=sv) .
...
När konfigurationen är klar visas de insamlade intressepunkterna på fliken **[!UICONTROL Places]** i varje profil. Så här öppnar du listan:
