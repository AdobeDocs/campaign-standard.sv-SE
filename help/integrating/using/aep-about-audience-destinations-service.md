...
När ett segment har skapats kan du sedan aktivera det som en målgrupp för en leverans i [Campaign Standard-arbetsflöden](../../integrating/using/aep-targeting-audiences.md). Dessutom kan du använda kontextdata från Adobe Experience Platform för att [anpassa](../../integrating/using/aep-personalizing-campaigns.md) och lägga till dynamiskt innehåll i dina kampanjer.
