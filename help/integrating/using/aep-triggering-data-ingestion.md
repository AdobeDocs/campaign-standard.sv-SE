...
Innan du använder API:erna måste datamappningen först ha konfigurerats och publicerats i Campaign Standard gränssnitt. Mer information om detta hittar du i dessa avsnitt.
...
Omedelbart intag av en XDM-mappning till Adobe Experience Platform utlöses av en POST-åtgärd:

`POST https://mc.adobe.io/<ORGANIZATION>/campaign/dataIngestion/xdmIngestion/<XDM Mapping ID>/ingest`

>[!NOTE]
>
>För att kunna köra inklistring av POST API-anrop måste användaren ha en **SQL-funktionskörningsroll** som en Campaign Standard-administratör kan ge genom att köra nedan JS-skript:
>
>```
...
Status för en begäran om att få tillgång till ett inlägg kan hämtas med en GET-åtgärd och det önskade ID:t för begäran i parametrarna:
...
>[!NOTE]
>
>Detaljerad information om status för XDM-mappningsbegäran och relaterade jobb finns i Campaign Standard-gränssnittet på menyn **[!UICONTROL Status of data export to platform]** (se [Mappningsaktivering](../../integrating/using/aep-mapping-activation.md)).
