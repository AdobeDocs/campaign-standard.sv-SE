...
* En e-postmall för Adobe Campaign har konfigurerats för att ta emot AEM-innehåll.

## Åtkomst till e-postmeddelanden i Adobe Experience Manager {#email-content-aem}

Logga in på din Adobe Experience Manager-instans och gå till den mapp som innehåller ditt e-postinnehåll via webbplatsen.
...
* **[!UICONTROL Adobe Campaign Email]**: den här mallen innehåller ett standardinnehåll som du kan anpassa. Du kan välja mellan e-post för Adobe Campaign (AC6.1) och e-post för Adobe Campaign (ACS).
...
1. Skapa ett nytt i Adobe Experience Manager **[!UICONTROL Page]**.
...
1. I **[!UICONTROL Page properties]** anger du **[!UICONTROL Adobe Campaign]** som **[!UICONTROL Cloud Service Configuration]**. Detta möjliggör kommunikation mellan ert innehåll och er Adobe Campaign-instans.
...
Du kan redigera e-postinnehållet genom att lägga till komponenter och resurser. Personaliseringsfält kan användas för att leverera ett mer relevant meddelande baserat på mottagarnas data i Adobe Campaign.
...
1. Välj valideringsarbetsflöde på **[!UICONTROL Workflow]** fliken **[!UICONTROL Approve for Adobe Campaign]** . Du kan inte skicka e-postmeddelanden i Adobe Campaign om det använder innehåll som inte har godkänts.
